...
export const RAIL_CLASS_LABELS_BY_LANGUAGE: Record<'zh' | 'ja' | 'en', Record<RailClass, string>> = {
...
export function defaultRailFilter(): RailFilterState {
  return {
    classes: Object.fromEntries(ALL_RAIL_CLASSES.map(c => [c, true])) as Record<RailClass, boolean>,
    statuses: {
      operational: true,
